    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        ...
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "TranslatesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    ...
                    Hit = table.Column<int>(type: "int", nullable: true)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    Slug = table.Column<string>(type: "nvarchar(170)", maxLength: 170, nullable: true)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "TranslatesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                    ...
                    MetaTitle = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    MetaDescription = table.Column<string>(type: "nvarchar(155)", maxLength: 155, nullable: true)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "TranslatesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Translates_Languages_LanguageCode",
                        column: x => x.LanguageCode,
                        principalTable: "Languages",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Translates_Pages_PageId",
                        column: x => x.PageId,
                        principalTable: "Pages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Translates_Products_ProductId",
            ...
            migrationBuilder.InsertData(
                table: "Languages",
                columns: new[] { "Code", "Name", "Visible" },
                values: new object[] { "tr-tr", "Türkçe", true });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Translates_CategoryId",
                table: "Translates",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Translates_LanguageCode",
                table: "Translates",
                column: "LanguageCode");

            migrationBuilder.CreateIndex(
                name: "IX_Translates_PageId",
                table: "Translates",
                column: "PageId");

            migrationBuilder.CreateIndex(
                name: "IX_Translates_ProductId",
                table: "Translates",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Translates_Slug",
                table: "Translates",
                column: "Slug",
                unique: true,
